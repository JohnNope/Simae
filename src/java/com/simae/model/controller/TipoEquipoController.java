...
import com.simae.model.facade.TipoEquipoFacade;
...
public class TipoEquipoController implements Serializable {
    ...
    @EJB
    private com.simae.model.facade.TipoEquipoFacade ejbFacade;
    ...
    public TipoEquipo getSelected() {
        if (current == null) {
            current = new TipoEquipo();
            selectedItemIndex = -1;
        }
        return current;
    }

    private TipoEquipoFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (TipoEquipo) getItems().getRowData();
    ...
    public static class TipoEquipoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TipoEquipoController controller = (TipoEquipoController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "tipoEquipoController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoEquipo) {
                ...
                return getStringKey(o.getCodigoTipoDeEquipo());
            } else {
